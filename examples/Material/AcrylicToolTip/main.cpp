...
public:
    Demo(QWidget* parent = nullptr) : Widget(parent)
    {
        ...
        button1->installEventFilter(new AcrylicToolTipFilter(button1, 0, ToolTip::Top));
        button2->installEventFilter(new AcrylicToolTipFilter(button2, 0, ToolTip::Bottom));
        button3->installEventFilter(new AcrylicToolTipFilter(button3, 300, ToolTip::Right));
